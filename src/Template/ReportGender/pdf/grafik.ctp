...
<script type="text/javascript">
	/**
		...
		function am4themes_myTheme(target) {
		  if (target instanceof am4core.ColorSet) {
		    target.list = [
		      am4core.color("#1B9CFC"),
		      am4core.color("#FC427B"),
	...
	chart.numberFormatter.numberFormat = "#.";		// Create axes
        ...
        chart.exporting.filePrefix = "Hasil Pemeriksaan Tekanan Darah berdasarkan Jenis Kelamin";
        ...
        title.text = "Hasil Pemeriksaan Tekanan Darah berdasarkan Jenis Kelamin ";
        
        title.fontSize = 25;
        title.marginBottom = 30;
		createSeries("pria", "Pria", false);
		createSeries("wanita", "Wanita", true);
